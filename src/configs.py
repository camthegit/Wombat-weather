"""Called when database.py loaded when init_db called from app.py. Uses python-dotenv and refers to settings.env
...
import logging  # was trying to log here but would not work
...
# TODO: stop exporting variables when OK
print(cnf.__repr__())  # comment out in production
logger.debug('Environment vbles %s' % repr(cnf))
